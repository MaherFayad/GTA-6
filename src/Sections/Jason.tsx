    ...
    return (
        <section className="jason">
            <div className="max-w-lg jason-content">
                ...
                <h2>
                    Jason want an easy life, but things just keep getting harder.
                </h2>

                <p>Jason grew up around grifters and crooks. After a stint in the
                ...
                <div className="jason-2">
                    <img alt="jason" src="/images/jason-2.webp" />
                </div>

            </div>
            <div className="space-y-5 mt-96 img-box">
                <div className="jason-1">
                    <img alt="jason" src="/images/jason-1.webp" />
                </div>
                <div className="jason-3">
                    <img alt="jason" src="/images/jason-3.webp" />
                </div>
            </div>
