...
const Outro = () => {
  useGSAP(() => {
    ...
    tl.to('.final', { opacity: 0, duration: 1, ease: 'power1.inOut' })
    ...
    <section className="final-message">
      <div className="h-full col-center gap-10">
        ...
        <div className="flex-center gap-10">
          <img src="/images/ps-logo.svg" className="md:w-32 w-20" alt="img" />
          <img src="/images/x-logo.svg" className="md:w-52 w-40" alt="img" />
        </div>
      </div>
    </section>
  )
